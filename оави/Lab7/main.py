...
# Пути
features_path = "features_new.csv"
image_path = "phrase.bmp"
output_dir = "output_recognition"
os.makedirs(output_dir, exist_ok=True)

# ===================== ЗАДАНИЕ 1 =====================
df = pd.read_csv(features_path, sep=";", encoding="cp1251")
df["mass"] = df["norm_mass_q1"] + df["norm_mass_q2"] + df["norm_mass_q3"] + df["norm_mass_q4"]
etalon_features = df[["mass", "cx_norm", "cy_norm", "Ix_norm", "Iy_norm"]].to_numpy()
...
# ===================== ЗАДАНИЯ 2–3 =====================
expected_string = "mephi best university"
recognized = []
...
# Вывод строки и точности ЗАДАНИЯ 6
