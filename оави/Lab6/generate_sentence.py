...
sentence = "mephi best university"
...
if __name__ == '__main__':
    ...
    initial.save(f"results/sentence_white13.bmp")
    initial = invert(initial)
    initial.save(f"results/sentence_black13.bmp")
    ...
    string.save(f"results/sentence_white23.bmp")

    string = invert(string)
    string.save(f"results/sentence_black23.bmp")